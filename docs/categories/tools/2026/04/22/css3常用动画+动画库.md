---
title: css3常用动画+动画库
description: css3常用动画+动画库。
author: PandaJS
date: 2026/04/22 10:48
isTop: false
categories:
  - 工具四海谈
tags:
...
文章整理了 `animate.css`、`magic.css`、`Effect.css`、`hover.css` 四类 CSS3 动画资源，并给出了一组覆盖淡入淡出、弹跳、旋转、翻转、闪烁、震颤、摇摆、摇晃、震铃等效果的常用动画类与关键帧代码，可作为 CSS3 动画学习、查阅与复用时的参考资料。
